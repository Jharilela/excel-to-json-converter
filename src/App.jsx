      ...
      <footer className="app-footer">
        <div className="footer-content">
          <div className="footer-section">
            <h4>Developed by Emp0</h4>
            <p>Professional tools for developers and businesses</p>
            <a href="https://emp0.com" target="_blank" rel="noopener noreferrer" className="footer-link">
              Visit Emp0.com
            </a>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="contact-links">
              <a href="mailto:tools@emp0.com" className="footer-link">
                <svg className="email-icon" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                </svg>
                tools@emp0.com
              </a>
              <a href="https://discord.com/users/jym.god" target="_blank" rel="noopener noreferrer" className="footer-link">
          ...
          <div className="footer-section">
            ...
            <a href="https://github.com/Jharilela/excel-to-json-converter" target="_blank" rel="noopener noreferrer" className="footer-link">
